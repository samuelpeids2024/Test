 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ft=()=>Lt().__FIREBASE_DEFAULTS__,xt=()=>{if(typeof process>"u"||typeof process.env>"u")return;const e={}.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},jt=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&$t(e[1]);return t&&JSON.parse(t)},Ht=()=>{try{return Ft()||xt()||jt()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},qe=()=>{var e;return(e=Ht())===null||e===void 0?void 0:e.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new tn("@firebase/app"),gn="@firebase/app-compat",mn="@firebase/analytics-compat",bn="@firebase/analytics",wn="@firebase/app-check-compat",yn="@firebase/app-check",In="@firebase/auth",En="@firebase/auth-compat",vn="@firebase/database",_n="@firebase/database-compat",Sn="@firebase/functions",Tn="@firebase/functions-compat",Dn="@firebase/installations",An="@firebase/installations-compat",Cn="@firebase/messaging",kn="@firebase/messaging-compat",On="@firebase/performance",Nn="@firebase/performance-compat",Bn="@firebase/remote-config",Mn="@firebase/remote-config-compat",Pn="@firebase/storage",Rn="@firebase/storage-compat",$n="@firebase/firestore",Ln="@firebase/firestore-compat",Fn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ie="[DEFAULT]",xn={[oe]:"fire-core",[gn]:"fire-core-compat",[bn]:"fire-analytics",[mn]:"fire-analytics-compat",[yn]:"fire-app-check",[wn]:"fire-app-check-compat",[In]:"fire-auth",[En]:"fire-auth-compat",[vn]:"fire-rtdb",[_n]:"fire-rtdb-compat",[Sn]:"fire-fn",[Tn]:"fire-fn-compat",[Dn]:"fire-iid",[An]:"fire-iid-compat",[Cn]:"fire-fcm",[kn]:"fire-fcm-compat",[On]:"fire-perf",[Nn]:"fire-perf-compat",[Bn]:"fire-rc",[Mn]:"fire-rc-compat",[Pn]:"fire-gcs",[Rn]:"fire-gcs-compat",[$n]:"fire-fst",[Ln]:"fire-fst-compat","fire-js":"fire-js",[Fn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vr=/^[cdef][\w-]{21}$/,ue="";function _r(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=Sr(e);return vr.test(n)?n:ue}catch{return ue}}function Sr(e){return Er(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr="firebase-installations-database",kr=1,S="firebase-installations-store";let Y=null;function ge(){return Y||(Y=ur(Cr,kr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(S)}}})),Y}async function M(e,t){const n=j(e),o=(await ge()).transaction(S,"readwrite"),i=o.objectStore(S),s=await i.get(n);return await i.put(t,n),await o.done,(!s||s.fid!==t.fid)&&pt(e,t.fid),t}async function mt(e){const t=j(e),r=(await ge()).transaction(S,"readwrite");await r.objectStore(S).delete(t),await r.done}async function H(e,t){const n=j(e),o=(await ge()).transaction(S,"readwrite"),i=o.objectStore(S),s=await i.get(n),a=t(s);return a===void 0?await i.delete(n):await i.put(a,n),await o.done,a&&(!s||s.fid!==a.fid)&&pt(e,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function me(e){let t;const n=await H(e.appConfig,r=>{const o=Or(r),i=Nr(e,o);return t=i.registrationPromise,i.installationEntry});return n.fid===ue?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Or(e){const t=e||{fid:_r(),registrationStatus:0};return bt(t)}function Nr(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(_.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=Br(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:Mr(e)}:{installationEntry:t}}async function Br(e,t){try{const n=await Ir(e,t);return M(e.appConfig,n)}catch(n){throw st(n)&&n.customData.serverCode===409?await mt(e.appConfig):await M(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function Mr(e){let t=await Re(e.appConfig);for(;t.registrationStatus===1;)await ft(100),t=await Re(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await me(e);return r||n}return t}function Re(e){return H(e,t=>{if(!t)throw _.create("installation-not-found");return bt(t)})}function bt(e){return Pr(e)?{fid:e.fid,registrationStatus:0}:e}function Pr(e){return e.registrationStatus===1&&e.registrationTime+rt<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fo(e,t){const n=await ve(e),r=St(t),o={method:"POST",headers:n,body:JSON.stringify(r)};let i;try{i=await(await fetch(Ee(e.appConfig),o)).json()}catch(s){throw f.create("token-subscribe-failed",{errorInfo:s==null?void 0:s.toString()})}if(i.error){const s=i.error.message;throw f.create("token-subscribe-failed",{errorInfo:s})}if(!i.token)throw f.create("token-subscribe-no-token");return i.token}async function ho(e,t){const n=await ve(e),r=St(t.subscriptionOptions),o={method:"PATCH",headers:n,body:JSON.stringify(r)};let i;try{i=await(await fetch(`${Ee(e.appConfig)}/${t.token}`,o)).json()}catch(s){throw f.create("token-update-failed",{errorInfo:s==null?void 0:s.toString()})}if(i.error){const s=i.error.message;throw f.create("token-update-failed",{errorInfo:s})}if(!i.token)throw f.create("token-update-no-token");return i.token}async function _t(e,t){const r={method:"DELETE",headers:await ve(e)};try{const i=await(await fetch(`${Ee(e.appConfig)}/${t}`,r)).json();if(i.error){const s=i.error.message;throw f.create("token-unsubscribe-failed",{errorInfo:s})}}catch(o){throw f.create("token-unsubscribe-failed",{errorInfo:o==null?void 0:o.toString()})}}function Ee({projectId:e}){return`${Zr}/projects/${e}/registrations`}async function ve({appConfig:e,installations:t}){const n=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function St({p256dh:e,auth:t,endpoint:n,vapidKey:r}){const o={web:{endpoint:n,auth:t,p256dh:e}};return r!==It&&(o.web.applicationPubKey=r),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oo=e=>{const t=new So(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>ko(t,n)),t},No=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:r=>Ct(t,r)}};function Bo(){v(new w("messaging",Oo,"PUBLIC")),v(new w("messaging-internal",No,"PRIVATE")),m(He,Ve),m(He,Ve,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $o(e=Un()){return Mo().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),fe(x(e),"messaging").getImmediate()}async function kt(e,t){return e=x(e),Ct(e,t)}function Lo(e){return e=x(e),Po(e)}function Fo(e,t){return e=x(e),Ro(e,t)}Bo();const xo={apiKey:"API_KEY",authDomain:"PROJECT_ID.firebaseapp.com",databaseURL:"https://PROJECT_ID.firebaseio.com",projectId:"PROJECT_ID",storageBucket:"PROJECT_ID.appspot.com",messagingSenderId:"SENDER_ID",appId:"APP_ID",measurementId:"G-MEASUREMENT_ID"},jo="<YOUR_PUBLIC_VAPID_KEY_HERE>";Xe(xo);const P=$o(),Ot="token_div",Nt="permission_div";Fo(P,e=>{console.log("Message received. ",e),Wo(e)});function _e(){qo(),R("loading..."),kt(P,{vapidKey:jo}).then(e=>{e?(Ho(e),zo(e)):(console.log("No registration token available. Request permission to generate one."),Go(),$(!1))}).catch(e=>{console.log("An error occurred while retrieving token. ",e),R("Error retrieving registration token."),$(!1)})}function R(e){const t=document.querySelector("#token");t.textContent=e}function Ho(e){Vo()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),$(!0))}function Vo(){return window.localStorage.getItem("sentToServer")==="1"}function $(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function L(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Uo(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{e==="granted"?(console.log("Notification permission granted."),_e()):console.log("Unable to get permission to notify.")})}function Ko(){kt(P).then(e=>{Lo(P).then(()=>{console.log("Token deleted.",e),$(!1),_e()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),R("Error retrieving registration token.")})}function Wo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function qo(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function zo(e){L(Ot,!0),L(Nt,!1),R(e)}function Go(){L(Ot,!1),L(Nt,!0)}document.getElementById("request-permission-button").addEventListener("click",Uo);document.getElementById("delete-token-button").addEventListener("click",Ko);_e();
